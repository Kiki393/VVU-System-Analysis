    ...
    <div class="sidebar pb-4 mb-4">
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu"
                ...
                <?php if ($_SESSION['login_type'] == 2 && 3): ?>
                    <li class="nav-item">
                        <a href="./index.php?page=contactUs" class="nav-link nav-contactUs">
                ...
                <?php if ($_SESSION['login_type'] == 1): ?>
                    ...
                    <li class="nav-item">
                        <a href="./index.php?page=email" class="nav-link nav-email">
                            <i class="far fa-envelope nav-icon"></i>
                            <p>Email</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="./index.php?page=messages" class="nav-link nav-messages">
